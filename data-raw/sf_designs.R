...
filenames <- list.files(path =
                "C:/Users/rebek/github/packages/DoEAna/data-raw/all_csv_data",
                        pattern = ".*csv")
# subset file names
...
for (i in seq_along(filenames)){
  filepath <-
  file.path("C:/Users/rebek/github/packages/DoEAna/data-raw/all_csv_data",
...
sf_designs <- rbind(all_raw_df_list[[1]], all_raw_df_list[[2]],
                    all_raw_df_list[[3]]
                ,
                ...
                ,
                all_raw_df_list[[10]], all_raw_df_list[[11]],
                all_raw_df_list[[12]],
                all_raw_df_list[[13]], all_raw_df_list[[14]],
                all_raw_df_list[[15]],
                all_raw_df_list[[16]], all_raw_df_list[[17]],
                all_raw_df_list[[18]])


usethis::use_data(sf_designs, overwrite = TRUE)

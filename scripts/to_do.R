...
# or for the simplex
my_design_sim <- select_design(d_data = sf_designs, geometry = "simplex", distance = "chebyshev", n = 30)
...
my_designM <- select_design(d_data = sf_designs, geometry = "hypercube",
                            distance = "manhattan", n = 10)
my_designE <- select_design(d_data = sf_designs, geometry = "hypercube",
                            distance = "euclidean", n = 10)
my_designC <- select_design(d_data = sf_designs, geometry = "hypercube",
